            ...
            <div id="demo1" style="float:left"><!-- 第一个宽度显示 -->
                 <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../page/detail.html?isbn=9787302435167"><img src="../img/recommend/recommend_img1.jpg" border="0"></a>
                    </div>
                    <p>大数据架构师指南</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../page/detail.html?isbn=9787115335500"><img src="../img/recommend/recommend_img2.jpg" border="0"></a>
                    </div>
                    <p>深入浅出Node.js</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../page/detail.html?isbn=9787111213826"><img src="../img/recommend/recommend_img3.jpg" border="0"></a>
                    </div>
                    <p>Java编程思想</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="../page/detail.html?isbn=9787111545682"><img src="../img/recommend/recommend_img4.jpg" border="0"></a>
                    </div>
                    <p>Linux运维最佳实践</p>
                </div>
                <!--</div>-->
        ...
        <div class="all">
            ...
            <div id="parm">
                ...
                <ul>
                    ...
                    <li>
                    	<a href="#">图书名称：<%=book.getTitle() %></a>
					</li>
                    <li>
                    	<a href="#">作者：<%=book.getAuthor() %> </a>
		            </li>
...
<script>
    ...
    $(function () {
        ...
        $("#collect").click(function (){
           	...
           	$.ajax({
                type: "post",
                url: '/day01/user/page/collectYesOrNoServlet',
    ...
    $("#add_cart").click(function (e) {
        ...
        $.ajax({
            type: "post",
            url: "/day01/user/page/addToCartServlet",
            data: params,
            success: function (data) {
                if (data == 'yes') {
                    alert("添加购物车成功！");
